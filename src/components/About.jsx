            ...
            <div className="about-member1 about-card">
              ...
              <div className="about-details">
                ...
                <p className="about-card-description">
                  ...
                  GeeksforGeeks, Leap Scholar Able Jobs(YC '19). Grew codedamn's
                  revenue by 20X using various growth strategies.
                </p>
              </div>
            </div>
            <div className="about-member1 about-card">
              ...
              <div className="about-details">
                ...
                <p className="about-card-description">
                  ...
                  brand from zero to 20k+ followers. He is also a content
                  creator and a meme marketer. He has worked with various brands
